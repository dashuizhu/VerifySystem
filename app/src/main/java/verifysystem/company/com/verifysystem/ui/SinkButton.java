 ...
 * 有下沉效果的Button
 */
public class SinkButton extends Button {
    private SinkButton mSinkButton;
    ...
    public SinkButton(Context context, AttributeSet attrs, int defStyleAttr) {
